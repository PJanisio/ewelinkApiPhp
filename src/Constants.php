...
class Constants
{
    ...
    // Europe: 'eu'
    // Asia: 'as'
    public const REGION = 'your_region';
    ...
    // Enable or disable saving the config.json file
    public const SAVE_CONFIG_JSON = true;
